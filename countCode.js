...
// küsi kasutajalt algustähte
//const letterToCheck = prompt('Sisesta algustäht, mida kontrollida: ');
function countCode(letterToCheck) {
let count = 0;

data.forEach(function(arrayItem,array){

   if(arrayItem.charAt(0).match(letterToCheck.charAt(0))){
     result.push(array[arrayItem]);
     count++;
   }
 })

 console.log("Sisestatud algustähega koode on kokku: " + count)
}
